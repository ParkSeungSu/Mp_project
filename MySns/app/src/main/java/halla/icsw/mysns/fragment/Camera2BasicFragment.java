...
import halla.icsw.mysns.view.AutoFitTextureView;
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                int[] afAvailableModes = characteristics.get(CameraCharacteristics.CONTROL_AE_AVAILABLE_ANTIBANDING_MODES);
                if (afAvailableModes.length == 0 || afAvailableModes.length == 1 && afAvailableModes[0] == CameraCharacteristics.COLOR_CORRECTION_ABERRATION_MODE_OFF) {
