...
public class ContentsItemView extends LinearLayout {
    ...
    private void initView() {
        ...
        addView(layoutInflater.inflate(R.layout.view_contents_images, this, false));
    ...
    public void setOnFocusChangeListener(OnFocusChangeListener onFocuseChangeListener){
        editText.setOnFocusChangeListener(onFocuseChangeListener);
    }
}
